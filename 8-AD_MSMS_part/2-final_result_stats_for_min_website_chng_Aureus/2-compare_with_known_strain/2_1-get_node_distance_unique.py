...
list1 = [i for i in list1 if i in unique_list]
list2 = [i for i in list2 if i in unique_list]
list3 = [i for i in list3 if i in unique_list]
list4 = [i for i in list4 if i in unique_list]
list5 = [i for i in list5 if i in unique_list]
